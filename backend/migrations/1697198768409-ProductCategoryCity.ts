...
export class ProductCategoryCity1697198768409 implements MigrationInterface {
    name = 'ProductCategoryCity1697198768409'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "category" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "published" boolean NOT NULL DEFAULT true, "slug" character varying NOT NULL, "slugRu" character varying NOT NULL, "cityId" integer, CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))`);
